...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int ADD_TO_FRONT = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int x = mLifecycleCallbacks.size()-1; x >= 0; x--){
            mLifecycleDisplay.append(mLifecycleCallbacks.get(x) + "\n");
        }
    ...
    protected void onStop() {
        ...
        mLifecycleCallbacks.add(ADD_TO_FRONT, ON_STOP);
    ...
    protected void onDestroy() {
        ...
        mLifecycleCallbacks.add(ADD_TO_FRONT, ON_DESTROY);
